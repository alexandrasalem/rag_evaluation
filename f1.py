from tools import normalize_answer, remove_punctuation, lemmatize_text

'''
This code is adapted from the following repository: https://github.com/mandarjoshi90/triviaqa
'''
